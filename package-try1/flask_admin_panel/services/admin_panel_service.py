...
class AdminPanelService(IAdminPanelService):
    ...
    def registeration(self):
        ...
        #     SourceDefinition,
        #     SourceMapping,
        #     TempUserToSourceMapping,
        # )
        # from apps.usermanagement.models import Roles, User

        # self.register_model_for_admin_panel("Source", Source)
        # self.register_model_for_admin_panel("SourceDefinition", SourceDefinition)
        # self.register_model_for_admin_panel("SourceMapping", SourceMapping)
        # self.register_model_for_admin_panel(
        #     "TempUserToSourceMapping", TempUserToSourceMapping
        # )
        # self.register_model_for_admin_panel("User", User)
        # self.register_model_for_admin_panel("Roles", Roles)
        # self.regenerate_all_model_configs()
        pass
