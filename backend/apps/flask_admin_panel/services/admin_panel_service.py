...
from apps.flask_admin_panel.interfaces import IAdminPanelService
from apps.flask_admin_panel.exceptions.exceptions_classes import ModelNotFoundException
